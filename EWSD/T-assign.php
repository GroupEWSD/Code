		...
		if ($resultx->num_rows > 0){
			...
			foreach ($_POST['T_mail'] as $Tval) {
				...
				if ($resulty->num_rows > 0){
					...
					$sqlf = "SELECT * FROM t_assign WHERE Sname ='$Smail'";
					...
					if ($resultf->num_rows > 0) {
						...
						echo "<script type='text/javascript'>window.location='T-assign.php';</script>";
					}
					
					else {
						
						$sql = "INSERT INTO t_assign (Sname,Tname) VALUES('$Smail','$Tmail')";
						...
						if (mysqli_query($conn, $sql)) {
							...
							if ($result2->num_rows > 0){
								...
								while($row2 = $result2->fetch_assoc()) {
									...
									$mail->Body = "<html></body><div style='padding-top:8px;'>Tutor ".$Tmail." Has been assign to assist you.</div>
													</body></html>";
							...
							if ($result3->num_rows > 0){
								...
								while($row3 = $result3->fetch_assoc()) {
									...
									$mail->Body = "<html></body><div style='padding-top:8px;'>Student ".$Smail." Has been assign under you.</div>
													</body></html>";
...
<div id="header">
    ...
    <a style="height: 20%; text-align: center; color: white;">ASSIGN STUDENT</a></h1>
</div>
<br>
...
<p style='text-align:center; font-size:20px;'>Allocate</p>
