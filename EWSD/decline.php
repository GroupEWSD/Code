<?php
	...
	$query = "UPDATE appointment SET status ='Decline' WHERE id ='$id'";
		
		if(mysqli_query($conn, $query)){
			
			echo $student;
			
			$sql = "SELECT * FROM user WHERE username ='$student'";
			...
			if ($result->num_rows > 0){
				...
				$mail->Body = "<html></body><div style='padding-top:8px;'>Your appointment has been decline</div>
								</body></html>";
				...
				header("Location: tutorAppoint.php"); 	
