...
if(isset($_POST['save'])){
	...
	$n=$_SESSION['username'];
	$sql2 ="SELECT * FROM messages WHERE student='$n'";
...
<?php
	...
	echo "<select name='tutor' style='margin-top:50px;'>";
	echo "<option value='Tutor Name'>Tutor Name</option>";
...
?>
<br><br><textarea class="message-input" name="message" placeholder="write your message"></textarea><br><br>
